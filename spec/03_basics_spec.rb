...
describe 'crazy stuff on arrays' do
  ...
  # BONUS : You can do this in one line less than 55 chars
      it 'does crazy stuff on Arrays 01' do
      expect(magic_array([1, 2, 3, 4, 5, 6]))
      .to eq([2, 4, 8, 10])
      end
      it 'does crazy stuff on Arrays 02' do
